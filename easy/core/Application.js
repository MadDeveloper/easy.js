...
const { ContainerBuilder } = require( 'easy/provider' )
const { Console, PolyFills, ConfigLoader, Router } = require( 'easy/core' )
const { Authentication } = require( 'easy/authentication' )
const { Configurable } = require( 'easy/interfaces' )
const { Database, DatabaseDaemon, EntityManager } = require( 'easy/database' )
