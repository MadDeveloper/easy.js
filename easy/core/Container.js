...
class Container {
    ...
    constructor( application, path ) {
        ...
        this._componentsMapping = {
            'router'         : 'easy/core/Router',
            'bundlemanager'  : 'easy/core/BundleManager',
            'entitymanager'  : 'easy/database/EntityManager',
            'database'       : 'easy/database/Database',
            'logger'         : 'easy/log/Logger',
            'logfilemanager' : 'easy/log/LogFileManager',
            'logwriter'      : 'easy/log/LogWriter'
        }
    ...
    loadComponent( name, clearCache = false ) {
        if ( "undefined" === typeof this.componentsLoaded[ name ] ) {
            if ( this.componentsMapping.hasOwnProperty( name ) ) {
                ...
                if ( fs.statSync( require.resolve( pathComponent ) ).isFile() ) {
                    if ( clearCache ) {
