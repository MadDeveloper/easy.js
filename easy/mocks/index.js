...
module.exports.file = require( 'easy/mocks/file.mock' )
module.exports.logger = require( 'easy/mocks/logger.mock' )
module.exports.logWriter = require( 'easy/mocks/logWriter.mock' )
module.exports.logDirectoryManager = require( 'easy/mocks/logDirectoryManager.mock' )
module.exports.token = require( 'easy/mocks/token.mock' )
