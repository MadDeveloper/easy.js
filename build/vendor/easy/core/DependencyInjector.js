...
function Container(Kernel) {
    ...
    return {
        ...
        isDependencyAlreadyLoaded: function isDependencyAlreadyLoaded(dependency) {
            return this.container.hasOwnProperty(dependency);
        },

        getDependency: function getDependency(dependency, params) {
        ...
        getService: function getService(service, clearCache) {
        ...
        getServiceDirectoryPath: function getServiceDirectoryPath() {
