...
var SkeletonFactory = function (_Factory) {
    _inherits(SkeletonFactory, _Factory);

    function SkeletonFactory(bundleManager) {
        _classCallCheck(this, SkeletonFactory);

        return _possibleConstructorReturn(this, Object.getPrototypeOf(SkeletonFactory).call(this, 'skeleton', bundleManager));
    }
