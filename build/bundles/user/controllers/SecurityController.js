...
var SecurityController = function (_Controller) {
    ...
    function SecurityController(userFactory) {
        ...
        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(SecurityController).call(this, userFactory.container));
            ...
            return new Promise(function (resolve, reject) {
                if (_this2.isProdEnv()) {
                    ...
                    thi.access.restrict({
                        ...
                        canCreate: [_this2.access.admin],
                        canRead: [],
                        canUpdate: [_this2.access.admin],
                        canDelete: [_this2.access.admin]
                    });
